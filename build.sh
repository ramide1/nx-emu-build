    ...
    1)
        ...
        case "$emu_version" in
            ...
            2)
                ...
                chmod +x appimage-builder.sh && echo "appimage script permissions updated correctly" || echo "error updating appimage script permissions" && cd ~/ && rm -rf "$emu_directory" && exit 1
                ./appimage-builder.sh torzu build && echo "appimage builded correctly" || echo "error building appimage" && cd ~/ && rm -rf "$emu_directory" && exit 1
